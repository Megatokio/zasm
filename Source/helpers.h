...
extern void write_compressed_page_z80	( FD&, int page_id, uint8 const* data, uint32 size );
extern void write_intel_hex 			( FD&, uint32 address, uint8 const* data, uint32 size );
extern uint write_motorola_s19			( FD&, uint32 address, uint8 const* data, uint32 size );
extern void write_srecord				( FD&, S19Type, uint32 address, uint8 const* data, uint size );
extern void write_compressed_page_ace	( FD&, uint8 const* data, uint size );
