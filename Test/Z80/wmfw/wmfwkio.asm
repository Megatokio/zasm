...
;		
	...
	SBC	HL, DE
	RET	M
;========== Load (D_96) with the value from dip switch 3
;	    Bits 0 - 6 represent the absolute binary value
;	    bit 7 indicates sign, not a 2s complement number
	IN	A, (DIP3)
	PUSH	AF
	AND	01111111B
	LD	DE, 0
