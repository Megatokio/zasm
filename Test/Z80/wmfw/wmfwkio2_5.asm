...
;	IF RESET + STOP ON DISABLE TWEAK	
;		
	IN	A, (EIO4)
	CP	01000010B
	JP	Z, TWEAK_1
...
;	IF RESET + START ON Enter pump count mode	
;		
	IN	A, (EIO4)
	CP	00100010B
...
FETCHPC_LV:			; Bill's addition
	...
	LD	IY, TWEAKTABLE
	LD	B, 20		; Number of dispensing volumes, 0 - 19 (0 is default for > 19)
...
FETCHPC_DT_2:			; Read in specific column Volume
	PUSH	BC
...
FETCHPC_DT_4:
	...
	INC	IY
	POP	BC
	DJNZ	FETCHPC_DT_2	; Read in all column volumes of a dispensing volume
	POP	BC
	DJNZ	FETCHPC_DT_1	; Read in all dispensing volumes 1 uL to 19 uL.
;	CALL	RAM2ROM
	RET
;
;~~~~~	
